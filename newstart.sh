...
export ETHEREUM_JSONRPC_HTTP_URL=https://rpc-testnet.wyzthchain.org/
export ETHEREUM_JSONRPC_WS_URL=ws://rpc-testnet.wyzthchain.org//ws
export DATABASE_URL=postgres://wyzscan:wyzpwd@localhost:5432/wyzscan?ssl=false
export ETHEREUM_JSONRPC_TRACE_URL=https://rpc-testnet.wyzthchain.org/ 
export NETWORK=WYZth Scan Testnet  Blockchain Explorer
