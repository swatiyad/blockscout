...
document.addEventListener("DOMContentLoaded", async function () {
  ...
  const fetchData = async (page) => {
    ...
    try {
      const apiResponse = await axios.get(`https://explorer.bitplug.io/node-api/internal-transactions?page=${page}&pageSize=50`);
              ...
              <tr>
                ...
                <td class="show_for_hompage text-right">
                  <span class="border rounded-sm p-1">
                    <span class="fs-10 font-weight-bold"> ${detail.value / 1e18} BTP </span>
                ...
                <!-- Value  -->
                <td class="hide_for_homepage">
                  <span class="">${detail.value / 1e18} BTP </span>
                </td>
...
document.addEventListener("DOMContentLoaded", async function () {
    const transactionCount = await axios.get(`https://explorer.bitplug.io/node-api//transaction-count`);
...
document.addEventListener("DOMContentLoaded", async function () {
    const blockCount = await axios.get(`https://explorer.bitplug.io/node-api/block-count`);
