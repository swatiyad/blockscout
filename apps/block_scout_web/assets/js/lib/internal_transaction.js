...
document.addEventListener("DOMContentLoaded", async function () {
  ...
  const fetchData = async (page) => {
    ...
    try {
      const apiResponse = await axios.get(`https://librascan.com/internal-transactions?page=${page}&pageSize=50`);
              ...
              <tr>
                ...
                <td class="show_for_hompage text-right">
                  <span class="border rounded-sm p-1">
                    <span class="fs-10 font-weight-bold"> ${detail.value / 1e18} LIBRA </span>
                ...
                <!-- Value  -->
                <td class="hide_for_homepage">
                  <span class="">${detail.value / 1e18} LIBRA </span>
                </td>
...
document.addEventListener("DOMContentLoaded", async function () {
    const transactionCount = await axios.get(`https://librascan.com/node-api/transaction-count`);
...
document.addEventListener("DOMContentLoaded", async function () {
    const blockCount = await axios.get(`https://librascan.com/node-api/block-count`);
