...
<div class="table-content-loader my-1 loader-height"></div>
  ...
  await Promise.all([
    axios.get("https://dccscan.com/node-api/topsender"),
    axios.get("https://dccscan.com/node-api/max-count-reciever"),
    axios.get("https://dccscan.com/node-api/max-count-sender"),
    axios.get("https://dccscan.com/node-api/top-stats-data"),
    axios.get("https://dccscan.com/node-api/token-data"),
  ]);
  ...
  `<div>
  <div class="media align-items-center mb-1">
    <div class="media-body">Top DCC Sender</div>
    <div class="text-right">Total DCC </div>
  </div>
  <div class="media align-items-center mb-1">
    <div class="media-body">
      <span
  ...
  <hr class="pb-1 hr" />
  <div class="media align-items-center mb-1">
    <div class="media-body">Top DCC Receiver</div>
    <div class="text-right">Total DCC</div>
  </div>
  <div class="media align-items-center mb-1">
    <div class="media-body">
