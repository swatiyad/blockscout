...
document.addEventListener("DOMContentLoaded", () => {
  ...
  async function displayData() {
    ...
    try {
      const response = await axios.post("https://inertiascan.com/node-api/get-user-icon-data/"+username);
  ...
  async function updateData(id, newData) {
    try {
      const response = await axios.put(`https://inertiascan.com/node-api/update-user-icon-data/${id}`, newData);
  ...
  async function deleteData(id) {
    try {
      const response = await axios.delete(`https://inertiascan.com/node-api/delete-user-icon-data/${id}`);
