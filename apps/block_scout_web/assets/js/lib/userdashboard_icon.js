...
document.addEventListener("DOMContentLoaded", () => {
  ...
  async function displayData() {
    ...
    try {
      const response = await axios.post("https://testnet.wyzthscan.org/node-api/get-user-icon-data/"+username);
  ...
  async function updateData(id, newData) {
    try {
      const response = await axios.put(`https://testnet.wyzthscan.org/node-api/update-user-icon-data/${id}`, newData);
  ...
  async function deleteData(id) {
    try {
      const response = await axios.delete(`https://testnet.wyzthscan.org/node-api/delete-user-icon-data/${id}`);
