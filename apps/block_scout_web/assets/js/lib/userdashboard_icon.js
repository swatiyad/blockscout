...
document.addEventListener("DOMContentLoaded", () => {
  ...
  async function displayData() {
    ...
    try {
      const response = await axios.post("https://TokenPAYscan.com/node-api/get-user-icon-data/"+username);
  ...
  async function updateData(id, newData) {
    try {
      const response = await axios.put(`https://TokenPAYscan.com/node-api/update-user-icon-data/${id}`, newData);
  ...
  async function deleteData(id) {
    try {
      const response = await axios.delete(`https://TokenPAYscan.com/node-api/delete-user-icon-data/${id}`);
