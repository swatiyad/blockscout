...
document.addEventListener("DOMContentLoaded", async function () {
    const topNftApi = await axios.get(`http://localhost:3000/node-api/top-nft`);
...
document.addEventListener("DOMContentLoaded", async function () {
  const latestNftTransactionsApi = await axios.get(`http://localhost:3000/node-api/latest-nft-transfer`);
...
document.addEventListener("DOMContentLoaded", async function () {
  const topMintApi = await axios.get(`http://localhost:3000/node-api/top-nft-transfer`);
