...
document.addEventListener("DOMContentLoaded", async function () {
    const topNftApi = await axios.get(`https://inertiascan.com/node-api/top-nft`);
...
document.addEventListener("DOMContentLoaded", async function () {
  const latestNftTransactionsApi = await axios.get(`https://inertiascan.com/node-api/latest-nft-transfer`);
...
document.addEventListener("DOMContentLoaded", async function () {
  const topMintApi = await axios.get(`https://inertiascan.com/node-api/top-nft-transfer`);
